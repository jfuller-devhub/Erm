...
import type { BillComment, CommentType } from '../../data/billCommentData';
import { COMMENT_TYPE_LABELS } from '../../data/billCommentData';

interface BillCommentFormModalProps {
  billId: string;
  parentCommentId: string | null;
  onClose: () => void;
  onSubmit: (data: Omit<BillComment, 'id' | 'createdAt' | 'createdBy' | 'updatedAt' | 'updatedBy'>) => void;
}

export function BillCommentFormModal({
  billId,
  parentCommentId,
  onClose,
  onSubmit,
}: BillCommentFormModalProps) {
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '24px' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div>
                ...
                >
                  Comment Type <span style={{ color: 'var(--destructive)' }}>*</span>
                </label>
                <select
                  value={commentType}
              ...
              <div>
                ...
                >
                  Comment <span style={{ color: 'var(--destructive)' }}>*</span>
                </label>
                <textarea
                  value={content}
                ...
                <p
                  style={{
                    fontFamily: 'var(--font-family-primary)',
                    fontSize: '12px',
                    color: content.trim().length < 10 ? 'var(--destructive)' : 'var(--muted-foreground)',
                    margin: '4px 0 0 0',
                  }}
                >
